...
<head>
    ...
    <title>{{ __('general.forbidden') }}</title>
    @vite(['resources/css/app.css'])
</head>
<body class="min-h-screen bg-background flex items-center justify-center px-4">
    <div class="text-center max-w-md">
        <p class="text-6xl font-bold text-destructive mb-4">403</p>
        <h1 class="text-2xl font-bold text-navy mb-2">{{ __('general.forbidden') }}</h1>
        <p class="text-muted mb-6">{{ __('general.forbidden_desc') }}</p>
