...
class ResourceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $resources = [
            ...
            ['Incident Reporting Template', 'A standardized template for documenting suspected cases while maintaining appropriate protocols and confidentiality.', ResourceType::Printable, 'Notificare/Sesizare', ['documentation', 'reporting', 'protocol'], 'Ministry of Internal Affairs', '2026-02-05', false],
            ...
            ['Multi-Agency Collaboration Protocol', 'Template for establishing collaborative relationships between schools, health services, police, and social services.', ResourceType::Printable, 'Studii, analize și cercetări', ['multi-agency', 'collaboration', 'protocol'], 'Ministry of Education', '2026-01-05', false],
            ...
            ['Self-Care for Professionals', 'Resources and strategies for managing vicarious trauma and maintaining mental health while working in child protection.', ResourceType::Guide, 'Training/Dezvoltare profesională', ['self-care', 'trauma', 'mental health'], 'Prof. Ion Ionescu', '2025-12-28', false],
            ...
            ['Age-Adapted Prevention Curriculum', 'Educational materials for teaching children of different ages about body autonomy, trusted adults, and seeking help.', ResourceType::Printable, 'Prevenire și educație', ['curriculum', 'education', 'age-appropriate'], 'Ministry of Education', '2025-12-15', false],
            ['Public Awareness Campaign Kit', 'Complete materials for running community awareness campaigns: posters, flyers, and social media content.', ResourceType::Online, 'Comunicare', ['campaign', 'awareness', 'promotional materials'], 'Child Protection Institute', '2026-02-10', true],
