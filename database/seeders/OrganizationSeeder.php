...
class OrganizationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $organizations = [
            ...
            ['Linia de Asistență Națională', 'Confidential, multilingual hotline providing immediate crisis support, referrals, and reporting assistance available nationwide.', 'București', ['Helpline-uri și linii de asistență', 'Intervenție și combatere', 'Servicii de outreach'], '112', 'support@liniadeasistenta.ro', 'www.liniadeasistenta.ro', '24/7', 'Sediu central, București', 'Instituții publice'],
